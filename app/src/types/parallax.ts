...
export function resolveMobileBackgroundWidthBucket(
  ...
  if (effectiveWidth >= 900) return 1024
  if (normalizedViewportWidth <= 320 && normalizedPixelRatio <= 1.5) return 480
  return 768
}
  ...
  layers : [
    {
      ...
      presetKey : 'layer-bg',
      name      : 'Background',
      imageSrc  : 'parallax/desktop/layer-bg-1920.webp',
      visible   : true,
      geometry  : {
        topPct    : -5,
        leftPct   : -5,
    ...
    },
    {
      ...
      presetKey : 'layer-mid',
      name      : 'Middle',
      imageSrc  : 'parallax/desktop/layer-mid-1920.webp',
      visible   : true,
      geometry  : {
        topPct    : -6,
        leftPct   : -6,
    ...
    },
    {
      ...
      presetKey : 'layer-fg',
      name      : 'Foreground',
      imageSrc  : 'parallax/desktop/layer-fg-1920.webp',
      visible   : true,
      geometry  : {
        topPct    : -12,
        leftPct   : -12,
