  ...
  <div class="about-modal-backdrop" @click="onBackdropClick">
    ...
    >
      ...
      <div class="about-modal-links">
        <a
          href="https://github.com/robert-hoffmann"
          target="_blank"
          rel="noopener"
        >GitHub</a>
        ...
        <span class="about-modal-sep" aria-hidden="true">·</span>
        <a
          href="https://x.com/itechnologynet"
          target="_blank"
          rel="noopener"
        >X</a>
      </div>
      ...
      <p class="about-modal-copy">
        &copy; {{ new Date().getFullYear() }} Robert Hoffmann
      </p>
    </div>
  </div>
</template>
