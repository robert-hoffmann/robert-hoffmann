 ...
 *
 * Input naming:
 *   design/gallery/<projectId>-<local-image-number>.*
 *
 * Test output:
 *   design/gallery/_test-normalized/index.html
 *   design/gallery/_test-normalized/images/<variant>/*.webp
 *   design/gallery/_test-normalized/thumbs/<variant>/*.webp
 */
...
const SOURCE_DIR   = join(PROJECT_ROOT, 'design/gallery')
const OUTPUT_DIR   = join(PROJECT_ROOT, 'design/gallery/_test-normalized')
