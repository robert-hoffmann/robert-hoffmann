#!/usr/bin/env node
/**
 * Regenerate the CV PDF and design-side review artifacts from curated app data.
 *
 * Source data:
 *   src/data/docs/cv.ts
...
const HTML_PATH       = join(CV_REVIEW_DIR, 'robert-hoffmann-cv.html')
const PDF_PATH        = join(PUBLIC_DOCS_DIR, 'robert-hoffmann-cv.pdf')
const PNG_PATH        = join(CV_REVIEW_DIR, 'robert-hoffmann-cv.png')
